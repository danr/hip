...
n#+LATEX_HEADER: \usepackage{fullpage,listings,courier}
...
Clock summary at [2012-02-01 Wed 23:44]
...
| Tasks                                                         |         | 19:45 |       |      |      |
| ONGOING Time planning                                         |         |       |  0:19 |      |      |
| TODO Fix the lambda bug                                       |         |       |  0:42 |      |      |
| DONE Fill results incrementally                               |         |       |  1:22 |      |      |
| TODO Report tasks                                             |         |       |  3:48 |      |      |
| TODO Fixed point induction                                    |         |       |       | 0:55 |      |
| NEXT Write introduction                                       |         |       |       | 2:33 |      |
| TODO Structural induction rewrite                             |         |       |       | 0:19 |      |
| TODO Results                                                  |         |       | 12:29 |      |      |
| TODO Prepare the test suite                                   |         |       |       | 3:18 |      |
| NEXT Patch the program to run all provers                     |         |       |       | 9:08 |      |
| NEXT Modify the code to accept both modes                     |         |       |       |      | 6:43 |
| DONE SPASS                                                    |         |       |       |      | 0:32 |
| DONE Prover9                                                  |         |       |       |      | 0:29 |
| TODO Equinox                                                  |         |       |       |      | 0:27 |
| DONE Vampire                                                  |         |       |       |      | 0:11 |
...
| DONE Meeting with Koen notes                                  |         |       |  1:04 |      |      |
#+END:
** Refile
** Completed
...
**** TODO Structural induction rewrite
...
**** TODO Put "propositional equality" somewhere, not Eq-equality
**** Misc
***** Refutation
...
***** NEXT Modify the code to accept both modes
...
#+END_SRC
**** TODO Disable combinatorial explosions from fpi and str ind
