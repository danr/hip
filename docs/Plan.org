...
*** Good when you don't have anything to do induction on
*** Examples of examples
**** map-iterate
**** repeat-iterate
**** append / plus
**** mirror-treeIterate
*** On mutual and subset of occuring functions
*** How it was implemented
*** Future work: depth machines
...
** TODO Related work
*** Coinduction work in Agda by NAD
** TODO Future work
