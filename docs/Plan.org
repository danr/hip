...
*** TODO Simple induction on several variables
    Combine this with the auto-depth problem. This would be nicep
...
*** TODO Approximation lemma with Nats instead
Some proofs take exteremly long time (> 1 min) with approximate with function
