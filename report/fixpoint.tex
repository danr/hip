...
\hs{f}. In the next section a way to rewrite any recursive function is
...
construction it is equal to the original definition of \hs{map}.
...
\noindent
While \hs{doublemap} is behaviourally equivalent to \hs{map} on total
