...
\noindent
The Haskell Inductive Prover, \hs{hip}, will report if it was provable
...
\hs{quickCheck} function on them, given that there are appropriate
\hs{Eq} and \hs{Arbitrary} instances provided.
