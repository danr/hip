...
\note{Discuss this with Moa and get references} Zeno translates its
...
the induction hypotheses. \note{Peter Dybjer maybe said that it could
  be seen as a very nice way to interact with a theorem prover, thanks
  to Agda.} A more constructive approach by \cite{dtatp}, where they
